...
const useStyles = makeStyles((theme) => ({
  ...
  feature: {
    ...
    minHeight: "30vh",
    position: "relative",
    background: `linear-gradient(120deg, #0300cc, #02007a)`,
  },
  intro: {
    position: "relative",
    background: `linear-gradient(120deg, #0300cc, #02007a)`,
      ...
      >
        {slideItems.map((item) => (
          <Slide
            ...
            style={{ background: `linear-gradient(120deg, #0300cc, #02007a)` }}
          />
        ))}
      </AutoRotatingCarousel>
    </div>
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} minWidth={315} alignSelf="center">
            ...
            <Box mt={3}>
              <Typography>
                Simply sign up as a verified user on Course App to start to
        ...
        >
            ...
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                <Typography style={{ marginTop: 16 }}>
                  Course App is collect on many resourses. People who study at
                  the Course App can archive knowledge by join suitable topic.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                <Typography variant="h4">
                  Course App users easy to achieve the desired skills
                </Typography>
                <Typography style={{ marginTop: 16 }}>
                  Course App system is meticulously built to enhance the
